									...
									<table cellpadding="2" cellspacing="1" width="100%">
										...
										<tr>
											...
											<td><select name="Marketing_Setting_Placing" size="10" class="form_select" sch_req="1" sch_msg="Placing">
													...
													<option <?php echo $form_data["MarketingPlacing"] == "Home Side Bar" ? "selected='selected'": "" ?>>Home Side Bar</option>
													<option <?php echo $form_data["MarketingPlacing"] == "Tag Top" ? "selected='selected'": "" ?>>Tag Top</option>
													<option <?php echo $form_data["MarketingPlacing"] == "Tag Bottom" ? "selected='selected'": "" ?>>Tag Bottom</option>
													<option <?php echo $form_data["MarketingPlacing"] == "Tag Side Bar" ? "selected='selected'": "" ?>>Tag Side Bar</option>
													<option <?php echo $form_data["MarketingPlacing"] == "Store Top" ? "selected='selected'": "" ?>>Store Top</option>
													<option <?php echo $form_data["MarketingPlacing"] == "Store Side Bar" ? "selected='selected'": "" ?>>Store Side Bar</option>
													<option <?php echo $form_data["MarketingPlacing"] == "Store Bottom" ? "selected='selected'": "" ?>>Store Bottom</option>
