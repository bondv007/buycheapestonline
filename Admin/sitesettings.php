<?php
	...
	if ( $_POST )
	{
		foreach ( $_POST as $fieldName => $fieldValue )
		{
			...
			{
				move_uploaded_file ( $_FILES["fleLogo"]["tmp_name"] , "../media/logo.png" ) ;
			}
		}
					...
					<form class="application_form" action="" method="post" enctype="multipart/form-data">
						<table cellpadding="2" cellspacing="1" width="80%">
							...
							<tr>
								...
								<td><input name="Site_Setting_Title" type="text" class="form_text" id="txtSiteTitle" value="<?php echo $dataArray["SiteTitle"] ?>" size="50" maxlength="500" />
									<img src="images/icons/help.png" onclick="showHelp(this)" style="cursor:pointer" />
							...
							<tr>
								...
								<td><input name="Site_Setting_Keyword" type="text" class="form_text" id="txtSiteKeywords" value="<?php echo $dataArray["SiteKeyword"] ?>" size="50" maxlength="200" />
								<img src="images/icons/help.png" onclick="showHelp(this)" style="cursor:pointer" />
							...
							<tr>
								...
								<td><input type="file" name="fleLogo" />
                                    <img src="images/icons/help.png" onclick="showHelp(this)" style="cursor:pointer" />
                                    <div class="div_help">Logo must be a .png file.</div>
									<br />
                                    <div style="background-color:#b63b00;">
									<?php
										echo "<img src='../media/logo.png' border='0' />" ;
									?>
                                    </div>
								</td>
							</tr>
							<tr>
								...
								<td><label>
									...
									Yes</label>
									<span style="color:#7F7F7F; font-size:12px;">Enable Security Code when posting coupon by user or comments.</span>
									<br />
									<label>
							...
							<tr>
								<td class="form_title" >Default Coupon Status</td>
								<td><label>
									<input name="Default_Setting_Status" value="1" type="radio" <?php echo intval ( $dataArray["DefaultStatus"] ) == 1 ? "checked='checked'" : "" ?> />
									Active</label>
									<span style="color:#7F7F7F; font-size:12px;">If you want Coupons when posted, it makes them online immediately</span>
									<br />
									<label>
									<input name="Default_Setting_Status" value="0" type="radio" <?php echo intval ( $dataArray["DefaultStatus"] ) == 0 ? "checked='checked'" : "" ?> />
									InActive</label>
									<span style="color:#7F7F7F; font-size:12px;">If you want Coupons to be verified by ADMIN</span>
								</td>
							</tr>
							
							<tr>
								<td class="form_title" >Default Comments Status</td>
								<td><label>
									<input name="DefaultStatusComments_Setting_" value="1" type="radio" <?php echo intval ( $dataArray["DefaultStatusComments"] ) == 1 ? "checked='checked'" : "" ?> />
									Active</label>
									<span style="color:#7F7F7F; font-size:12px;">If you want comments when posted, it makes them online immediately</span>
									<br />
									<label>
									<input name="DefaultStatusComments_Setting_" value="0" type="radio" <?php echo intval ( $dataArray["DefaultStatusComments"] ) == 0 ? "checked='checked'" : "" ?> />
									InActive</label>
									<span style="color:#7F7F7F; font-size:12px;">If you want comments to be verified by ADMIN</span>
								</td>
							</tr>
