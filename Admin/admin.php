							...
							<tr>
								...
								<td width="76%" valign="top" style="padding-left:15px;">
									<table>
										...
										<tr>
											<td>Allow Coupon Management</td>
											<td>
												<label><input type="radio" name="IsCoupon_Manage_Setting_" value="1" <?php echo intval ( $form_data["IsCoupon_Manage"] ) > 0 ? "checked='checked'" : "" ?> /> Yes </label>
												<label><input type="radio" name="IsCoupon_Manage_Setting_" value="0" <?php echo intval ( $form_data["IsCoupon_Manage"] ) == 0 ? "checked='checked'" : "" ?> /> No </label>
											</td>
										</tr>
										<tr>
											<td>Allow Website Management</td>
											<td>
												<label><input type="radio" name="IsWebsite_Manage_Setting_" value="1" <?php echo intval ( $form_data["IsWebsite_Manage"] ) > 0 ? "checked='checked'" : "" ?> /> Yes </label>
												<label><input type="radio" name="IsWebsite_Manage_Setting_" value="0" <?php echo intval ( $form_data["IsWebsite_Manage"] ) == 0 ? "checked='checked'" : "" ?> /> No </label>
											</td>
										</tr>
										<tr>
											<td>Allow Tag Management</td>
											<td>
												<label><input type="radio" name="IsTag_Manage_Setting_" value="1" <?php echo intval ( $form_data["IsTag_Manage"] ) > 0 ? "checked='checked'" : "" ?> /> Yes </label>
												<label><input type="radio" name="IsTag_Manage_Setting_" value="0" <?php echo intval ( $form_data["IsTag_Manage"] ) == 0 ? "checked='checked'" : "" ?> /> No </label>
											</td>
										</tr>
										<tr>
											<td>Allow Comments Management</td>
											<td>
												<label><input type="radio" name="IsComment_Manage_Setting_" value="1" <?php echo intval ( $form_data["IsComment_Manage"] ) > 0 ? "checked='checked'" : "" ?> /> Yes </label>
												<label><input type="radio" name="IsComment_Manage_Setting_" value="0" <?php echo intval ( $form_data["IsComment_Manage"] ) == 0 ? "checked='checked'" : "" ?> /> No </label>
											</td>
										</tr>
										<tr>
